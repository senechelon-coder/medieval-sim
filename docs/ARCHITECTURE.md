...
Not yet built (deferred, beyond the exit bar): NPC king death/succession as an alternative independent-world-event example, multiple battle templates, and any deeper war-score effects on the map/kingdoms (no territory actually changes hands yet).
